...
export default function AdminPage() {
  ...
  async function activate(target: Instance) {
    ...
    if (!window.confirm(`切换到“${target.instance_label}”？新病例将保存在该服务器，历史数据不会自动同步。`)) return;
    setBusy(true);
    setError(null);
    try {
